...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy({ "node_modules/markdown-it-admon/styles/admonition.css": "./admonition.css" });
  ...
  let markdownItAdmon = require('markdown-it-admon');
  ...
  let markdownLib = markdownIt(options).use(mdIterator, 'url_new_win', 'link_open', function (tokens, idx) {
